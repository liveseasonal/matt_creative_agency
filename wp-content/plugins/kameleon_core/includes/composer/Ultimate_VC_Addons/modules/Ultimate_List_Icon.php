...
if(!class_exists('Ultimate_List_Icon'))
{
	class Ultimate_List_Icon
	{
		...
		function icon_list_item_shortcode($atts, $content = null){
			...
			$content_font_family = $content_font_style = $content_font_size = $content_line_ht = $content_font_color = $css_icon_list = $sy_hover_style = $sy_hover_background = $sy_hover_color = '';
			extract(shortcode_atts( array(
				'icon_type' => 'selector',
				'icon'=> '',
				'icon_img' => '',
			...
			if($icon !== "" || $icon_img !== ''){
				...
				$main_icon = do_shortcode('[just_icon icon_type="'.$icon_type.'" icon="'.$icon.'" icon_img="'.$icon_img.'" img_width="'.$icon_size.'" icon_size="'.$icon_size.'" icon_color="'.$icon_color.'" icon_style="'.$icon_style.'" icon_color_bg="'.$icon_color_bg.'" icon_color_border="'.$icon_color_border.'"  icon_border_style="'.$icon_border_style.'" icon_border_size="'.$icon_border_size.'" icon_border_radius="'.$icon_border_radius.'" sy_hover_color="'.$sy_hover_color.'"  sy_hover_style="'.$sy_hover_style.'" sy_hover_background="'.$sy_hover_background.'"	icon_border_spacing="'.$icon_border_spacing.'" icon_link="'.$icon_link.'" icon_animation="'.$icon_animation.'"]');
