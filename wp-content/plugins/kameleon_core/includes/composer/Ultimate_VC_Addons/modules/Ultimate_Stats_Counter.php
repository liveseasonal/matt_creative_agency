...
if(!class_exists('AIO_Stats_Counter'))
{
	class AIO_Stats_Counter
	{
		...
		function counter_shortcode($atts)
		{
			...
			$title_font = $title_font_style = $title_font_size = $title_font_color = $desc_font = $desc_font_style = $desc_font_size = $desc_font_color = $suf_pref_typography = $suf_pref_font = $suf_pref_font_style = $suf_pref_font_color = $suf_pref_font_size = $suf_pref_line_height = $sy_hover_style = $sy_hover_background = $sy_hover_color = $sy_hover_style = $sy_hover_background = $sy_hover_color = '';
			...
			//$font_args = array();
			$stats_icon = do_shortcode('[just_icon icon_type="'.$icon_type.'" icon="'.$icon.'" icon_img="'.$icon_img.'" img_width="'.$img_width.'" icon_size="'.$icon_size.'" icon_color="'.$icon_color.'" icon_style="'.$icon_style.'" icon_color_bg="'.$icon_color_bg.'" sy_hover_color="'.$sy_hover_color.'"  sy_hover_style="'.$sy_hover_style.'" sy_hover_background="'.$sy_hover_background.'" icon_color_border="'.$icon_color_border.'"  icon_border_style="'.$icon_border_style.'" icon_border_size="'.$icon_border_size.'" icon_border_radius="'.$icon_border_radius.'" icon_border_spacing="'.$icon_border_spacing.'" icon_link="'.$icon_link.'" icon_animation="'.$icon_animation.'"]');
