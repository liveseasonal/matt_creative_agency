...
if(!class_exists('AIO_Icons_Box'))
{
	class AIO_Icons_Box
	{
		...
		function icon_boxes($atts, $content = null)
		{
			...
			$title_font = $title_font_style = $title_font_size = $title_font_color = $desc_font = $desc_font_style = $desc_font_size = $desc_font_color = $box_min_height = $sy_hover_style = $sy_hover_background = $sy_hover_color = '';
			...
			$sy_top_align = '';
 			if($pos == 'top')
				$sy_top_align = '--sy-elem-align:'.$sy_elem_align.';';

			$box_icon = do_shortcode('[just_icon icon_type="'.$icon_type.'" icon="'.$icon.'" icon_img="'.$icon_img.'" img_width="'.$img_width.'" icon_size="'.$icon_size.'" icon_color="'.$icon_color.'" icon_style="'.$icon_style.'" icon_color_bg="'.$icon_color_bg.'" icon_color_border="'.$icon_color_border.'" sy_hover_color="'.$sy_hover_color.'"  sy_hover_style="'.$sy_hover_style.'" sy_hover_background="'.$sy_hover_background.'" icon_border_style="'.$icon_border_style.'" icon_border_size="'.$icon_border_size.'" icon_border_radius="'.$icon_border_radius.'" icon_border_spacing="'.$icon_border_spacing.'" icon_animation="'.$icon_animation.'"]');
			$prefix .= '<div data-pos="'.$pos.'" class="aio-icon-component '.$inf_design_style.' '.$css_class.' '.$el_class.' '.$hover_effect.'" style="'.$sy_top_align.'">';
					...
					array(
						...
						"params" => array(
							...
							array(
								...
								"param_name" => "sy_hover_background",
								"value" => "#ffffff",
								"description" => __("Select background color for icon.", "ultimate_vc"),
								"dependency" => Array("element" => "icon_style", "value" => array("advanced")),
							),
							array(
								"type" => "colorpicker",
								"class" => "",
								"heading" => __("Hover Icon Color", "ultimate_vc"),
								"param_name" => "sy_hover_color",
								"value" => "#333",
								"description" => __("Select background color for icon.", "ultimate_vc"),
								"dependency" => Array("element" => "icon_style", "value" => array("advanced")),
							),
							array(
								"type" => "dropdown",
								"class" => "",
								"heading" => __("Icon Hover Style Effect", "ultimate_vc"),
								"param_name" => "sy_hover_style",
								"value" => array(
									__("None","ultimate_vc") => "",
								...
								"description" => __("Choose the icon hover style","ultimate_vc"),
								"dependency" => Array("element" => "icon_style", "value" => array("advanced")),
							),
							array(
								"type" => "dropdown",
							...
							array(
								"type" => "dropdown",
								"class" => "",
								"heading" => __("Elements Alignement", "ultimate_vc"),
								"param_name" => "sy_elem_align",
								"value" => array(
									__("Center","ultimate_vc") => "center",
									__("Left","ultimate_vc") => "left",
									__("Right","ultimate_vc") => "right",
								),
								"dependency" => Array("element" => "pos","value" => array("top")),

								"description" => __("Choose Elements Alignement", "ultimate_vc")
							),
							array(
								"type" => "number",
								"class" => "",
