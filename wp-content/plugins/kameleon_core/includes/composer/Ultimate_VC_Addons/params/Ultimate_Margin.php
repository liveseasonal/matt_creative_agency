	...
	class Ultimate_Margin_Param
	{
		function __construct()
		{
			if(defined('WPB_VC_VERSION') && version_compare(WPB_VC_VERSION, 4.8) >= 0) {
				...
				{
					vc_add_shortcode_param('ultimate_margins', array($this, 'ultimate_margins_param'), KAMELEON_PLUGIN_URL.'includes/composer/Ultimate_VC_Addons/admin/vc_extend/js/vc-headings-param.js');
				}
			}
			else {
				if(function_exists('add_shortcode_param'))
				{
					add_shortcode_param('ultimate_margins', array($this, 'ultimate_margins_param'), KAMELEON_PLUGIN_URL.'includes/composer/Ultimate_VC_Addons/admin/vc_extend/js/vc-headings-param.js');
				}
			}
		}
