...
/* ================================================================== *\
   ...
   ==============           HEADER VERSION 8   		   ============== 
\* ================================================================== */
	$elementsHeaderV8 = array(	
        	array(
        		'id' => 'header_v8_onepage',
		        'type' => 'switch',
	...
	$sections[] = array(
        'title' => '8- Side Slide Normal',
		'icon' => 'flaticon-header',
        'id' => 'header_8_section',        						
		'icon_class' => 'icon-large',
        'desc' =>esc_html__('Styling the global header version 8 (Logo Left + Hamburger Icon Right) Slide Effect', 'kameleon'),
        'subsection' => true,
        'fields' => kameleon_header_shared_elements('header_v8',$elementsHeaderV8)       
    );
