...
\* ================================================================== */
	...
	$sections[] = array(
        'title' => '3- Center Header',
		'icon' => 'flaticon-header',
        'id' => 'header_3_section',        								
		'icon_class' => 'icon-large',
        'desc' =>esc_html__('Styling the global header version center(Menu Left + Logo Center + Menu Right)', 'kameleon'),
        'subsection' => true,
        'fields' => kameleon_header_shared_elements('header_v3',$elementsHeaderV3)
