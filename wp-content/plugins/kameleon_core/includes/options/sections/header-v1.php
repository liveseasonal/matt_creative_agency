...
/* ================================================================== *\
   ...
   ==============           HEADER VERSION 1   		   ============== 
\* ================================================================== */
	$elementsHeaderV1 = array(	
        	array(
        		'id' => 'header_v1_onepage',
		        'type' => 'switch',
	...
	$sections[] = array(
        'title' => '1- Header Simple',
		'icon' => 'flaticon-header',
        'id' => 'header_1_section',        						
		'icon_class' => 'icon-large',
        'desc' =>esc_html__('Styling the global header version one (Logo Left + Menu Right)', 'kameleon'),
        'subsection' => true,
        'fields' => kameleon_header_shared_elements('header_v1',$elementsHeaderV1)       
    );
