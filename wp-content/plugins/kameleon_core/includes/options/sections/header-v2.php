...
/* ================================================================== *\
   ...
   ==============           HEADER VERSION 2   		   ============== 
\* ================================================================== */
	$elementsHeaderV2 = array(
        	array(
        		'id' => 'header_v2_onepage',
		        'type' => 'switch',
	...
	//header v2 subsection
	$sections[] = array(
        'title' => '2- Header Logo Right',
		'icon' => 'flaticon-header',
		'icon_class' => 'icon-large',
        'id' => 'header_2_section',        								
        'desc' =>esc_html__('Styling the global header version two (Menu Left + Logo Right)', 'kameleon'),
        'subsection' => true,
        'fields' =>  kameleon_header_shared_elements('header_v2',$elementsHeaderV2)
