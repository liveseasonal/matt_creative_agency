...
/* ================================================================== *\
   ...
   ==============           HEADER VERSION 10   		   ============== 
\* ================================================================== */
	$elementsHeaderV10 = array(	
        	array(
        		'id' => 'header_v10_onepage',
		        'type' => 'switch',
	...
	$sections[] = array(
        'title' => '10- Header Fullscreen Normal',
		'icon' => 'flaticon-header',
        'id' => 'header_10_section',        						
		'icon_class' => 'icon-large',
        'desc' =>esc_html__('Styling the global header version 10 (Logo Left + Hamburger Icon Right) Full Screen', 'kameleon'),
        'subsection' => true,
        'fields' => kameleon_header_shared_elements('header_v10',$elementsHeaderV10)       
    );
