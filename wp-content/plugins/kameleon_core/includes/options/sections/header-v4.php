...
\* ================================================================== */
		...
		$elementsHeaderV4 =array(
        	array(
        		'id' => 'header_v4_onepage',
		        'type' => 'switch',
        	...
        	array(
		        ...
		        'subtitle' => esc_html__('Apply a height for fixed the header', 'kameleon'),
		        'default'  => '70',
			    'min'      => '20',
			    'step'     => '1',
			    'max'      => '150',	
...
//header v4 subsection
	$sections[] = array(
        'title' => '4- Center Header Logo top',
		'icon' => 'flaticon-header',
        'id' => 'header_4_section',        						
		'icon_class' => 'icon-large',
        'desc' =>esc_html__('Styling the global header version center(Logo TOP Center + Menu Bottom)', 'kameleon'),
        'subsection' => true,
        'fields' => kameleon_header_shared_elements('header_v4',$elementsHeaderV4)
