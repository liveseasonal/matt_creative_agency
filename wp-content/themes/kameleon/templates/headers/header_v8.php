<?php 
	...
	$hv_sticky  = ( ($is_single) && null !== get_post_meta(get_the_ID(), "hv_sticky", true)) ? 
		get_post_meta(get_the_ID(), "hv_sticky", true) : $sy_options['hv8_sticky'];

	$header_background = (isset($sy_options['hv8_background']['rgba'])) ? $sy_options['hv8_background']['rgba'] : '#fff';	
	$h_logo_type = $sy_options['hv8_logo_type'];	
	$hv_logo_matgintop = $sy_options['hv8_logo_matgintop'];		
	$border_color = $sy_options['hv8_border_color'];
	$border_px = $sy_options['hv8_border_thickness'];
	$text_color = $sy_options['hv8_text_color'];	
	$height = $sy_options['hv8_height']; 
	$logo_height = $sy_options['hv8_logo_height']; 
	$logo_width = $sy_options['hv8_logo_width']; 
	$hv_transparent = $sy_options['hv8_transparent'];	
	$sticky_height = $sy_options['sticky_height'];
	$hv_width = $sy_options['hv8_width'];
	$hv_sticky_width = $sy_options['hv8_sticky_width'];
...
?>
<header id="km-header" class="header_v8" data-sticky-full-width="<?php echo esc_attr($hv_sticky_width); ?>" data-starter-width="<?php echo esc_attr($hv_width); ?>" data-width="<?php echo esc_attr($hv_width); ?>" style="--border-color-header:<?php echo $border_color; ?>; background-color: <?php echo wp_kses_data($header_background); ?>;" data-fixed="<?php echo esc_attr($hv_transparent); ?>">	
