<?php 
/*
	Template Name: Portfolio  Full Width 4 Columns 	
*/
...
<div id="km-content" >
	<div id="km-checker">
		<div id="km-data" style="overflow: hidden;">			
			...
			<div class="km-portfolio-loop km-pf-container-simple" data-gutter="0" data-layout="full_4col_layout" data-number="<?php echo esc_attr($folio_per_page); ?>" >	
