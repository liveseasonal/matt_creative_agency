...
* 
*/
class SayenThemes_Options_slider{
	...
	function render(){		
		...
		$number_inputs .= '<div class="km-slider-range-container"><input type="number" step="1" min="'.$min.'" max="'.$max.'" size="4"  data-type="number" onkeyup="kameleon_change_range(this)"  name="'.esc_attr($name).'" value="'.esc_attr($value).'"  class="km-slider-input" min="'.$min.'" max="'.$max.'" size="4">
		<div class="km-slider-range-parent"><div class="km-slider-range-filled" ></div>
		<input type="range" step="1" value="'.esc_attr($value).'" data-type="slider" class="km-slider-range" min="'.$min.'" max="'.$max.'" size="4"  oninput="kameleon_change_range(this)" onchange="kameleon_change_range(this)"></div></div>';
