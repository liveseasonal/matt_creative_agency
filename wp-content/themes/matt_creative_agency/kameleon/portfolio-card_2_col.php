<?php 
/*
	Template Name: Portfolio Card 2 Columns 	
*/
...
<div id="km-content" >
	<div id="km-checker" data-sidebar-position="<?php echo esc_attr($sb_position); ?>">
		<div id="km-data" class="center-content" style="padding-bottom: 20px; padding-right: 5px; padding-left: 5px; box-sizing: border-box;">
			...
			<div class="km-portfolio-loop km-pf-container-simple" data-gutter="25" data-layout="card_2col_layout" data-number="<?php echo esc_attr($folio_per_page); ?>" >	
