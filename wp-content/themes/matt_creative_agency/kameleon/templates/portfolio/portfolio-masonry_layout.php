<?php 
	...
	$folio_masonry = get_post_meta($post->ID ,'folio_masonry', true );
?>
<div href="<?php the_permalink(); ?>" class="portfolio-masonry-item <?php echo esc_attr($folio_masonry); ?> effect-sadie portfolio-item-hidden portfolio-item <?php echo esc_attr($folio_classes); ?>" >
