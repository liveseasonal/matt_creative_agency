...
?>
<div class="portfolio-card-3col portfolio-card-item portfolio-item-hidden portfolio-item <?php echo esc_attr($folio_classes); ?>" >	
	<a href="<?php esc_url(the_permalink()); ?>"><?php sy_portfolio_thumbnail(''); ?></a>	
	<div class="portfolio-card-info portfolio-card-info-hidden" data-sit="hidden">
		<a href="<?php esc_url(the_permalink()); ?>" class="pc-title clst-hover"><?php the_title(); ?></a>
