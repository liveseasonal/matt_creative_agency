<?php 
/*
	Template Name: Portfolio Simple 4 Columns Full Width 	
*/
...
<div id="km-content" >
	<div id="km-checker" data-sidebar-position="<?php echo esc_attr($sb_position); ?>">
		<div id="km-data" class="center-content" style="overflow: hidden; padding-bottom: 20px;">
			...
			<div class="km-portfolio-loop km-pf-container-simple" data-gutter="25" data-layout="simple_4col_layout" data-number="<?php echo esc_attr($folio_per_page); ?>" >	
